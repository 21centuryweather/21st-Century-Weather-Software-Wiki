...
A VSCode pop-up window will ask you about the authenticity of host `gadi-cpu-<you gadi ARE node ID>`. Type `yes` into the pop-up wheuthenticity of host asked about the window and hit `Enter`.
